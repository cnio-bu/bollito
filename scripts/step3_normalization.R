...
ggsave(paste0(dir.name, "/",folders[2], "/1_viz_dim_loadings.png"), height = height, width = height * aspect_ratio)
...
ggsave(paste0(dir.name, "/",folders[2], "/4_jackstrawplot.png"), height = 10 , width = 20)
