...
message("2. Metadata from sample.tsv was added to Seurat object.")
...
if (input_type == "matrix") {
  if (file.exists(toString(units[sample,"metadata"]))){
    ...
    message("2.1 Metadata from metadata.tsv was added to Seurat object.")
  }
} else {
...
message("3. Ribosomal and mitochondrial percentages were calculated.")
...
message("4. Combined violin plot was generated.")
...
message("5. Scaterplots were generated.")
